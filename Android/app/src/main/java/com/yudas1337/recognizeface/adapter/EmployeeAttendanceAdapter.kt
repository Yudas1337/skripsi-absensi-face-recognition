...
class EmployeeAttendanceAdapter(private val dbHelper: DBHelper, private val results: List<AttendanceData>) : RecyclerView.Adapter<EmployeeAttendanceAdapter.ViewHolder>() {
