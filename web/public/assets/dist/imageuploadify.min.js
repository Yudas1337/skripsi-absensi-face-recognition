				...
				$.ajax({
					...
					success: function (response) {
						if (response.meta.code === 200) {
							...
							var firstErrorMessage = response.errors[firstKey][0];
							errorMessage += firstKey + ": " + firstErrorMessage + "\n";
						}
					},
					error: function (response) {
						...
						Object.keys(response.responseJSON.errors).forEach(function (key) {
							var errorMessages = response.responseJSON.errors[key];
							var firstErrorMessage = errorMessages[0];
							errorMessage += firstErrorMessage + "<br>";
						});
